...
local function CreateLabel(Parent: Instance, Name: string, Text: string, Size: UDim2, Position: UDim2): TextLabel
    ...
    Label.Size = Size or UDim2.new(1, 0, 0, 16)
...
local function SetDraggable(Frame)
    local dragging
    local dragInput
    local dragStart
    local startPos
...
TabHandler_Frame.BorderColor3 = Color3.fromRGB(160, 64, 160)
...
ToolTip_Label.BackgroundColor3 = Color3.fromRGB(160, 64, 160)
...
function Menu.Prompt(Message: string, Callback: any, ...)
    ...
    Prompt.BackgroundColor3 = Color3.fromRGB(160, 64, 160)
...
function Menu.Spectators(): Spectators
    ...
    Frame.BorderColor3 = Color3.fromRGB(160, 64, 160)
    Frame.BorderMode = Enum.BorderMode.Inset
    ...
    List.BorderColor3 = Color3.fromRGB(160, 64, 160)
    List.BorderMode = Enum.BorderMode.Inset
...
function Menu.Watermark(): Watermark
    ...
    Watermark.Frame.BorderColor3 = Color3.fromRGB(160, 64, 160)
...
Menu.CheckBox("MAIN", "Toggle", "Stremeable", getgenv().Settings.Enabled, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/Stremeable/refs/heads/main/STREMEABLEE.txt",true))()
    getgenv().Settings.Enabled = value
end, "Checkbox Tooltip")

Menu.CheckBox("MAIN", "Toggle", "Camera", getgenv().Settings.Camera, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/ZATIIV2/refs/heads/main/ZATIROOV2.txt",true))()
    getgenv().Settings.Camera = value
end)



Menu.CheckBox("MAIN", "Toggle", "Esp", getgenv().Settings.NOTIF, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/ESPP/refs/heads/main/obf_dxssZZ47X4vzb91y1ey2Aw62J2F1rn3yPY42vBW1AI5w3yJd520625qlY57D57ZQ.lua",true))()
...
Menu.CheckBox("MAIN", "Toggle", "auto shoot", getgenv().Settings.AUTOPRED, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/AutoShoot/refs/heads/main/AUTOSHOOOTT.lua", true))()
...
Menu.CheckBox("MAIN", "Misc", "Show Users", getgenv().Settings.AutoAir, function()
    loadstring(game:HttpGet("https://pastebin.com/raw/CPJDtUEx", true))()
    getgenv().Settings.ShowUsers = Value
end)
...
Menu.CheckBox("MISC", "Cframe", "Cframe", getgenv().cframespeedtoggle, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/cframe/refs/heads/main/cframe.txt", true))()
...
Menu.TextBox("MISC", "Cframe", "Cframe Speed", tostring(getgenv().speedvalue), function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/cframe/refs/heads/main/cframe.txt", true))()
...
Menu.CheckBox("MISC", "Orbit", "Toggle", getgenv().Settings.TargetStrafe.Enabled, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Matteoscripther/ORBITT/refs/heads/main/ORBITT.lua", true))()
end)

Menu.ComboBox("MISC", "Orbit", "Strafe Type", getgenv().Settings.StrafeType, {"Randomize", "Orbit"}, function()
    getgenv().Settings.StrafeType = selected
end, "Select Resolver Type")

Menu.CheckBox("MISC", "Orbit", "View", getgenv().Settings.View, function()
...
Menu.Slider("MISC", "TriggerBot", "Fov Size", 5, 300, getgenv().FOVSize or 25, "", 1, function()
